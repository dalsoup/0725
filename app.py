...
# ----------------------- 🧭 UI 시작 -----------------------
st.title("HeatAI: 폭염 대응 보상제도 트리거 예측 및 학습")
...
with st.expander("ℹ️ 학습 데이터 기록 안내"):
    st.markdown("""
    **2021년부터 2025년 7월 24일까지**의 기상 정보와 온열질환자 수 데이터는 이미 AI 모델에 반영되어 있습니다.  
    **2025년 7월 25일 이후**의 데이터를 추가로 학습시켜 모델을 최신 상태로 유지할 수 있습니다.

    **✅ 사용 방법**
    1. 상단에서 **2025년 7월 25일 이후 날짜 중 ‘오늘 기준 하루 전까지’**를 선택합니다.  
       ⏱️ *이는 정확한 기상 관측값(ASOS 데이터)을 반영하기 위해 설정된 제한입니다.*
