...
with tab3:
    ...
    try:
        with st.container():
            ...
            with col2:
                selected_gu_placeholder = st.selectbox("🏘️ 자치구 선택", [], key="placeholder_select")  # placeholder
        ...
        selected_gu = st.selectbox("🏘️ 자치구 선택", sorted(static_data["자치구"].unique()), index=0, key="final_select")
