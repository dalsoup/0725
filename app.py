...
with tab3:
    ...
    with st.expander("📊 tab3에서 산출된 정보는 이렇게 활용됩니다"):
        ...
        2. 📉 **사후 피해점수**: tab2에서 수집된 실제 환자 수(P_real)와 환경적 취약성(E), 최근 폭염 지속일(H)을 반영하여 최종 보상금 산정에 활용됩니다.
        ...
        - 🔥 H: 최근 7일간 최고체감온도 기반 폭염 지속 가중치 (1.0 ~ 1.3)
        ...
        **사후 피해점수** = 100 × (0.2 × S + 0.2 × E + 0.5 × P_pred + 0.1 × P_real) × H
        ...
        👉 최근 7일간 체감온도 기준으로 폭염이 **2일 이상 지속**되면 가중치가 자동으로 반영됩니다.
        (주의보 수준 33℃ 이상 → 1.15배, 경보 수준 35℃ 이상 → 1.30배)
        """)
